...
(function () {
  ...
  function createToggleButton(direction: 'left' | 'right'): HTMLButtonElement {
  ...
  function createOutlinePanel(): HTMLElement {
  ...
  function updateOutlineContent(): void {
